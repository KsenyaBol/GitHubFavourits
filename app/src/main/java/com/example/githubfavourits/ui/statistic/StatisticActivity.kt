...
class StatisticActivity : BaseActivity(R.layout.activity_statistic), StatisticView,
    ...
    override var direction: Enum<RepoRepository.DateValue> = RepoRepository.DateValue.YEAR
...
//            barArrayList.add(BarEntry(value.starredAt.toString().toFloat(), value.userList.size.toFloat()))
//        }
